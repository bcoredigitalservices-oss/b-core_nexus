...
.login-form-panel {
  ...
  padding: 3rem 1rem;
  background: var(--bg-main);
  background-image: linear-gradient(135deg, rgba(255,255,255,0.8) 0%, rgba(246,249,252,0.8) 100%);
  position: relative;
  z-index: 1;
}
...
.login-card {
  ...
  border: 1px solid rgba(0, 0, 0, 0.08); /* Stronger stroke */
  border-radius: 20px; /* Rounder corners */
  padding: 3rem 2.5rem;
  box-shadow: 
    0 20px 40px -10px rgba(0, 0, 0, 0.08), 
    0 0 0 1px rgba(0, 0, 0, 0.02), /* Outer micro-stroke */
...
/* Optional: Top brand line on the card */
.login-card::before {
  content: '';
  position: absolute;
  top: 0;
  ...
  right: 0;
  height: 4px;
  background: linear-gradient(90deg, var(--accent-primary), #00F5A0);
}
...
.login-label {
  ...
  color: var(--text-main); /* Darker label for contrast */
}
...
.login-input {
  ...
  background: var(--bg-main);
  border: 1.5px solid rgba(0, 0, 0, 0.1); /* Thicker stroke */
  border-radius: 12px;
  color: var(--text-main);
  font-family: var(--font-body);
  font-size: 0.95rem;
...
.login-input:focus {
  ...
  box-shadow: 0 0 0 4px rgba(99, 91, 255, 0.15), inset 0 2px 4px rgba(0,0,0,0.02);
}
...
.login-eye-btn:hover { color: var(--text-main); background: rgba(0,0,0,0.05); }
...
.login-btn {
  ...
  color: #ffffff;
  box-shadow: 0 4px 14px rgba(99, 91, 255, 0.3), inset 0 1px 0 rgba(255,255,255,0.2);
  transition: all 0.2s cubic-bezier(0.16, 1, 0.3, 1);
}

.login-btn:hover:not(:disabled) {
  transform: translateY(-2px);
  box-shadow: 0 6px 20px rgba(99, 91, 255, 0.4), inset 0 1px 0 rgba(255,255,255,0.2);
  background: #524ade;
}
...
.login-sso-btn {
  ...
  border: 1.5px solid rgba(0, 0, 0, 0.1); /* Stronger stroke */
  background: var(--bg-card);
  color: var(--text-main);
  border-radius: 12px;
  font-family: var(--font-body);
...
.login-checkbox {
  ...
  width: 18px;
  height: 18px;
  border: 1.5px solid rgba(0, 0, 0, 0.2); /* Defined stroke */
  background: var(--bg-card);
  border-radius: 5px;
  cursor: pointer;
  position: relative;
...
.login-text-highlight {
  color: var(--accent-primary); /* Pop out the highlight */
  font-weight: 700;
}
...
.login-feature-card {
  background: var(--bg-card);
  border: 1.5px solid rgba(0, 0, 0, 0.08); /* More visible stroke */
  border-radius: 16px;
  padding: 1.5rem;
  text-align: left;
