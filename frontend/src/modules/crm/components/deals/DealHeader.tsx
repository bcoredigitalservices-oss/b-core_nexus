...
export function DealHeader({ totalCount, onCreateClick }: DealHeaderProps) {
  return (
      ...
      <div className="flex items-center gap-3.5">
        ...
        <div>
          ...
          <p className="text-[var(--text-muted)] text-xs mt-1 m-0">
            Total active sales opportunities: <span className="text-[var(--text-main)] font-black">{totalCount}</span>
          </p>
        </div>
      </div>
